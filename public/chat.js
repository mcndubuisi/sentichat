...
/*****************************************
 * BEGIN String method to remove stop words
 *****************************************/
...
/*****************************************
 * END String method to remove stop words
 *****************************************/
...
let username = 'User' + getRandomArbitrary(100, 1000);
...
$(function() {
    ...
    socket.on('chat message', function(msg) {
        // remove stop words and assign it to clean_msg
        clean_msg = msg.removeStopWords();
        // perform sentiment analysis on message without stop words (clean_msg)
        let analysis = sentimood.analyze(clean_msg);
        ...
        function bgColor() {
            ...
            switch (average) {
                ...
                case -2:
                case -1:
                    // socket.emit('background image', "url('/img/negative.png')");
                    $("body").css("background-image", "url('/img/negative.png')");
                    break;
                case 0:
                case 1:
                    // socket.emit('background image', "url('/img/neutral.png')");
                ...
                case 4:
                case 5:
                    // socket.emit('background image', "url('/img/positive.png')");
